...
import 'package:kaia_mobile_app/presentation/screen/calendar_utils.dart';
...
class _PresenceScreenState extends State<PresenceScreen> {
  ...
  Future<void> initDateTimeMap() async {
    final presenceRepository = PresenceRepository();
    final response = await presenceRepository.fetchAndTransformEvents();
